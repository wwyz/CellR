...
function aboutusfun(){
    layer.msg("<img src=\"img/neb.png \" height=\"60\" width=\"60\"><br><div>细胞进化需要星云链网页前端的支持,这样可以进行DNA融合，体验到更多游戏性。<br> 下载地址:<br><a href=\"https:\/\/github.com\/ChengOrangeJu\/WebExtensionWallet\">https://github.com/ChengOrangeJu/WebExtensionWallet\</a><br><br>关于捐赠:<br>如果喜欢Cell Revolution可以对合约进行捐赠,<br>合约内作者没有任何提钱的方法,该捐赠是捐献给生态,每次的成功融合会获取合约内的1%<br><br>小记:<br>设计这款游戏的初衷就是想要做出一款真正的游戏,不是区块链的发币，博傻等传统意义上的游戏，我认为区块链是一种工具,让游戏过程,数据更加高效透明的情况下,通过自己的链上逻辑,拥有自己的生态逻辑,可以让游戏过程更加独具游戏性。接着我发现跟传统意义不一样，如果真的有一个游戏可以让所有人参与进生态,无数个体决定世界的走向，那么这就不是一个单机经营，一个简单的积分榜，而是一个真正的匿名群体游戏，有追逐高分的玩家，有群体合作的玩家，有新手，也有高玩，有创造者，也有修补者，各色各样的个体构建一个真正的区块链游戏, Cell Revolution.<br>希望你们喜欢。 -Ling</div>",{
              time: 0 //不自动关闭
